...
For each cell independently, we simulate events of cell division occurring periodically. During cell division, half of the methylation marks are randomly removed, replaced by unmethylated histones. Meanwhile, half of the PRC2 complexes are removed from current positions and re-initiated at the nucleation sites, while the other half remain where they are.
