...
parser$add_argument("-a", "--alpha", type = "double", default = 1.2,
...
parser$add_argument("--pme2", type = "double", default = 0.2, 
...
parser$add_argument("--pme3adj", type = "double", default = 0.2, 
...
parser$add_argument("-N", "--Npop", type = "integer", default = 5, 
                    help = "number of cells")
parser$add_argument("--Nenzyme1", type = "integer", default = 7, 
                    help = "number of PRC2 molecules initially bound at peak1")
parser$add_argument("--Nenzyme2", type = "integer", default = 7, 
...
parser$add_argument("--TSSTES", type = "integer", default = c(2100,2400,3500,3750), nargs = '+', 
                    help = "start/end coordinates for actively transcribed regions")
parser$add_argument("--K36Me3", type = "integer", default = c(2100,2400,3500,3750), nargs = '+', 
                    help = "start/end coordinates for regions with K36me3 marks; generally overlapping with actively transcribed regions")
parser$add_argument("--K36Me2", type = "integer", default = c(2401,2700), nargs = '+',
...
parser$add_argument("--K36me2harm01", type = "double", default = 5, 
                    help = "K36me2 decreases me0 to me1 conversion rate by K36me2harm01-fold")
parser$add_argument("--K36me2harm12", type = "double", default = 7.5, 
                    help = "K36me2 decreases me1 to me2 conversion rate by K36me2harm12-fold")
parser$add_argument("--K36me2harm23", type = "double", default = 15, 
...
parser$add_argument("--periodExpression", type = "integer", default = 200, 
